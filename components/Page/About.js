        ...
        <>
            ...
            <div className="flex flex-col justify-between w-full h-full gap-10 mt-20 lg:flex-row">
                <div className="flex flex-col items-center gap-10">
                    ...
                    <p className="w-full py-2 mx-auto text-3xl font-semibold text-center text-white bg-dark_mart md:bg-white md:w-2/3 md:text-slate-800">Were a team of expert clerks. Dedicated to helping you find the best goods at all hours of your day.</p>
                    <ul className="flex flex-col gap-4 ml-8 text-2xl font-semibold text-gray-600 list-disc md:gap-10 md:ml-0">
                        <li>Open 24/7</li>
