...
export default function About() {
    return(
        <>
            <motion.div className="flex flex-col items-center justify-center gap-2 px-4 mt-10 text-center" id='about'
            variants={fadeIn}
            initial="hidden"
            animate="visible"
            >
            ...
            <motion.div className="flex flex-col justify-between w-full h-full gap-10 mt-20 lg:flex-row" 
            variants={fadeIn}
            initial="hidden"
            animate="visible"
            >
