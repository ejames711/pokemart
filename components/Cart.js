...
export default function Cart({cartOpen, setCartOpen}) {
    ...
    return(
        <div className="flex flex-col items-center md:items-end" >
            ...
            {cartOpen ?
            <motion.div className="absolute flex flex-col items-center p-2 bg-white rounded shadow-xl top-14 w-96 lg:w-[500px] mr-4 max-h-96 overflow-y-auto" variants={fadeIn} initial="hidden" animate="visible">
